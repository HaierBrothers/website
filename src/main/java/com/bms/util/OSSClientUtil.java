...
public class OSSClientUtil {
	...
	// accessKey
	private String accessKeyId = "LTAIEfh6t0LW24bD";
	private String accessKeySecret = "0BV84hZBbdj2Afh7kCeRRs60X4VujJ";
	// 空间
	private String bucketName = "xlkdk3lfak3";
	// 文件存储目录
	private String filedir = "logo";
